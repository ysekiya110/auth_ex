  ...
  function DropBack(props: { backId: string, over: string[], select: string[][] }) {//分割画像の場所：画像の配置場所
    ...
    if (props.select.length > 0) {
      ...
      if (isSelected) {
        ...
        return (
          <img src={`/~ysekiya/auth_ex1/img/img_${selected[0][0]}.jpg`} style={{ height: 70, width: 70, objectFit: "cover", objectPosition: position }} />
        )
      }
    }
  ...
  function NextButton() {
    if (selectList.length === 3) {
      ...
      if (name !== null) {
        ...
        // window.location.href = `../inputUser/index.html`
      }
    } else {
      console.log("No")
    }
    ...
    <>
      ...
      <DndContext onDragEnd={handleDragEnd} onDragOver={handleDragOver} onDragStart={handleDragStart} >
        ...
        {!modal ?
          <table id="images">
            <tr>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_1.jpg"} dragId={1} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_2.jpg"} dragId={2} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_3.jpg"} dragId={3} /> </td>
            </tr>
            <tr>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_4.jpg"} dragId={4} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_5.jpg"} dragId={5} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_6.jpg"} dragId={6} /> </td>
            </tr>
            <tr>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_7.jpg"} dragId={7} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_8.jpg"} dragId={8} /> </td>
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_9.jpg"} dragId={9} /> </td>
            </tr>
            ...
            <tr>
              ...
              <td> <ModalImage onClick={modalEvent} Img={"/~ysekiya/auth_ex1/img/img_10.jpg"} dragId={10} /> </td>
          ...
          <div className="scrollable-container">
            <table id="selectedImage">
              ...
              <tr>
                ...
                <td> <img src={`/~ysekiya/auth_ex1/img/img_${modalId}.jpg`} style={{ background: "#e9e9e9", margin: 20, width: 140, height: 140, }} /> </td>
